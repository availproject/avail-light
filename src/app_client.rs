...
mod tests {
	...
	// 	let db = crate::db::data::mem::MemoryDB::default();
	// 	let mut p2p_client = crate::network::MockClient::new();
	// 	let mut rpc_client = crate::network::MockClient::new();

	// 	let mut mock_client = AppClient {
	// 		db,
	// 		p2p_client,
	// 		rpc_client,
	// 	};
	...
	// 	let mut mock_client = AppClient::new();
