...
use crate::network::generic_proto::handler::{
    NotifsHandlerIn, NotifsHandlerOut, NotifsHandlerProto,
};
use crate::network::generic_proto::upgrade::RegisteredProtocol;
...
pub struct GenericProto {
    ...
    generic_protocol: RegisteredProtocol,
...
impl GenericProto {
    ...
    pub fn new(
        ...
        let generic_protocol = RegisteredProtocol::new(protocol, versions);
...
impl NetworkBehaviour for GenericProto {
    ...
    fn new_handler(&mut self) -> Self::ProtocolsHandler {
        NotifsHandlerProto::new(self.generic_protocol.clone(), self.notif_protocols.clone())
    }
