...
impl DiscoveryConfig {
    ...
    pub fn add_protocol(&mut self, p: Vec<u8>) -> &mut Self {
...
impl DiscoveryBehaviour {
    ...
    pub fn num_kademlia_records(&mut self) -> impl ExactSizeIterator<Item = (&Vec<u8>, usize)> {
    ...
    pub fn kademlia_records_total_size(
        &mut self,
    ) -> impl ExactSizeIterator<Item = (&Vec<u8>, usize)> {
...
pub enum DiscoveryOut {
    ...
    /// Started a random Kademlia query for each DHT identified by the given `Vec<u8>`s.
    RandomKademliaStarted(Vec<Vec<u8>>),
}

impl NetworkBehaviour for DiscoveryBehaviour {
    type ProtocolsHandler = MultiHandler<Vec<u8>, KademliaHandler<QueryId>>;
            ...
            .map(|_| {
                ...
                let behaviour = {
                    ...
                    config
                        ...
                        .discovery_limit(50)
                        .add_protocol(Vec::<u8>::from(protocol_id));
